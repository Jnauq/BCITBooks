...
<div class="detail_item">
  <form id="form1" class="form center" action="post_confirm.php" name="posting" onsubmit="return check_input()" method="post" enctype="multipart/form-data">
    ...
    <div class="pickup">
      <p>Pick-up campus</p>
      <p>&nbsp;<input type="checkbox" name="location" value="Burnaby campus" id="burnabyCam" checked/><label for="burnabyCam">&nbsp;Burnaby</label>&nbsp;
      <input type="checkbox" name="location" value="Downtown campus" id="downtownCam"/><label for="downtownCam">&nbsp;Downtown</label>
      </p>
    </div>
  </div>
  <div id="post_right">
